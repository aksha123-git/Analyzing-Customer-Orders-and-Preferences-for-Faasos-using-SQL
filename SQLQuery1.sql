...
/*1.How many roll are make*/
select count(roll_id) from customer_orders;

/*2. How many unqiue customer order is made?*/
select count(distinct customer_id) from customer_orders;


/*3. How many successfull order delviered by driver?*/
...
5. How many veg and non veg rolls order by customer?
 ...
 6. What is the maximum numbers of rolls delviered in a single order?
